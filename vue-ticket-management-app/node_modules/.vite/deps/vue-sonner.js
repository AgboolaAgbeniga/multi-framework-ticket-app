...
var Observer = class {
  constructor() {
    ...
    __publicField(this, "custom", (component, data) => {
      ...
      const dismissible = (data == null ? void 0 : data.dismissible) === void 0 ? true : data.dismissible;
      if (this.dismissedToasts.has(id)) this.dismissedToasts.delete(id);
      if (alreadyExists) this.toasts = this.toasts.map((toast$1) => {
        if (toast$1.id === id) {
          this.publish({
      ...
      return openBlock(), createElementBlock(Fragment, null, [createCommentVNode(" Remove item from normal navigation flow, only available via hotkey "), createBaseVNode("section", {
        ...
        return openBlock(), createElementBlock("ol", mergeProps({
          ...
          return openBlock(), createBlock(Toast_default, {
            ...
            position: pos,
            closeButtonPosition: ((_e = _ctx.toastOptions) == null ? void 0 : _e.closeButtonPosition) ?? _ctx.closeButtonPosition,
            style: normalizeStyle((_f = _ctx.toastOptions) == null ? void 0 : _f.style),
            unstyled: (_g = _ctx.toastOptions) == null ? void 0 : _g.unstyled,
            classes: (_h = _ctx.toastOptions) == null ? void 0 : _h.classes,
            cancelButtonStyle: (_i = _ctx.toastOptions) == null ? void 0 : _i.cancelButtonStyle,
            actionButtonStyle: (_j = _ctx.toastOptions) == null ? void 0 : _j.actionButtonStyle,
